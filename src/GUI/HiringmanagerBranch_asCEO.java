...
public class HiringmanagerBranch_asCEO extends JFrame implements ActionListener{
...
public HiringmanagerBranch_asCEO() {
frame= new JFrame();
panel= new JPanel();
frame.setExtendedState(JFrame.MAXIMIZED_BOTH); 
frame.setSize(600, 400);
frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
frame.setTitle("Hiring Manger For Branch as CEO");
frame.add(panel);
