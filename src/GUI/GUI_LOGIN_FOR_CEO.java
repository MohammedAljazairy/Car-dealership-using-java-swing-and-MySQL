...
public class GUI_LOGIN_FOR_CEO extends JFrame implements ActionListener {
	/**
	 * 
	 */
...
frame.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if(Database.Connection_To_Database_Authentication_login_CEO(useer, pasword) == false) {
			if( useer.equals("0")  && pasword.equals("admin")) {
			count=0;
			frame.dispose();
			frame.setTitle("");
			new CEO();
