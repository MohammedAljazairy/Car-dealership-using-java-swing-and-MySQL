...
public class Hiring_manager_onEmp_asCEO extends JFrame implements ActionListener{
...
public Hiring_manager_onEmp_asCEO() {
frame= new JFrame();
panel= new JPanel();
frame.setExtendedState(JFrame.MAXIMIZED_BOTH); 
frame.setSize(600, 400);
frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
frame.setTitle("Hiring Manager on Employee as CEO");
frame.add(panel);
