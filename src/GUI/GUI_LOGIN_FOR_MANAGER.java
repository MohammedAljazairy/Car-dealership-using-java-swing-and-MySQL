...
public class GUI_LOGIN_FOR_MANAGER extends JFrame implements ActionListener {
	/**
	 * 
	 */
...
frame.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {		
		...
		int department = Database.Connection_To_Database_Authentication_login_Manager(useer, pasword);
