...
public class Hiring_Manager_department extends JFrame implements ActionListener{
...
public Hiring_Manager_department() {
frame= new JFrame();
panel= new JPanel();
frame.setExtendedState(JFrame.MAXIMIZED_BOTH); 
frame.setSize(600, 400);
frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
frame.setTitle("Hiring Manager For Department");
frame.add(panel);
