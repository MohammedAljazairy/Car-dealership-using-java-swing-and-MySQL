...
public class HiringManager_department_asCEO extends JFrame implements ActionListener{
...
public HiringManager_department_asCEO() {
frame= new JFrame();
panel= new JPanel();
frame.setExtendedState(JFrame.MAXIMIZED_BOTH); 
frame.setSize(600, 400);
frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
frame.setTitle("Hiring Manager For Department as CEO");
frame.add(panel);
